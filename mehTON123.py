...
find_this_word_2 = '</span></span></div><span'
# switcher = False
...
while(True):
    ...
    if check_internet_connection():
        ...
        if(index_of_dollar != -1):
            ...
            target = driver.page_source[index_of_dollar + len(find_this_word) : index_of_dollar_2 - len(find_this_word_2) ]###- (index_of_dollar_2-index_of_dollar)
