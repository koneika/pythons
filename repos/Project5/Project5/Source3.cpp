...
//	{
//		int value;
//		int* arr = new int[times]; // типо у нас теперь массив динамический с тримя количеством или сколько ты там задал
//
//
//		cin >> arr[times];
//
...
Node* add_node(Node* second, int Value)// для того чтобы создавать беконечное количество функций
{
	...
	head->Next = second;// возвращаем по этой функции, структуру head
