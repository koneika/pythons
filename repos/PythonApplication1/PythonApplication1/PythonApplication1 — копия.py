...
def repeat_all_message(message):
    ...
    banWord = 'xui'#, "пиз", "хуя", "ебе", "ебё", "ебя", "ебу", "еба", "еби", "пох", "бля", "нах", "сук", "лох"]
    NoBanWord = ['teb']
    ...
    # for j in range(0, len(txt2)):
    #     for i in range (0, len(banWord)):
    #         if txt2[j] in banWord[i] or banWord[i] in txt2[j]:
    #             ban = True
    #         else:
    #             if txt2[j] in NoBanWord[i] or NoBanWord[i] in txt2[j]:
    #                 for j in range(0, len(txt2)):
    #                      for i in range (0, len(banWord)):
